...
function P(id: number, name: string, brand: string, cat: string, price: number, old: number, rating: number, reviews: number, stock: number, img: string, opts: Partial<Product> = {}): Product {
  return {
    ...
    images: Array.isArray(img) ? (img as any).map((i:string)=>U(i)) : [U(img)],
    imageId: Array.isArray(img) ? (img as string[])[0] : img,
...
export const PRODUCTS: Product[] = [
  // ---- Health & Beauty ----
  P(1,'Maybelline Superstay Teddy Tint Lip & Cheek Color 5ml','Maybelline','beauty',3650,0,4.5,1,35,'1556228720-195a672e8a03',{featured:true,bestSeller:true,description:'Superstay Teddy Tint lip and cheek color, 5ml. Long-lasting vibrant color.'}),
  ...
  P(6,'Listerine Total Care Zero Mouth Wash 500ml','Listerine','beauty',1200,0,4.3,55,50,'1556228453-efd6c1ff04f6',{description:'Total Care Zero alcohol mouth wash, 500ml. Complete oral protection.'}),
  ...
  // ---- Grocery & Pet Care ----
  P(13,'Remia Thousand Island Salad Dressing 250ml','Remia','grocery',1030,0,4.3,25,60,'1542838132-8c5d0fb1f8d4',{description:'Classic Thousand Island salad dressing, 250ml bottle.'}),
  ...
  P(16,'Bisconni Chai Wala Plain Cake 20g','Bisconni','grocery',20,0,4.0,200,100,'1574088330827-7b8e4d2e7b2c',{bestSeller:true,description:'Chai Wala plain cake, 20g pack. Perfect with tea!'}),
  ...
  P(18,'Daffodils Space Rocket Jelly Beans 68g','Daffodils','grocery',325,0,4.1,18,90,'1585428103455-9b8c6e0f1f8c',{isNew:true,description:'Space rocket jelly beans candy, 68g. Fun treat for kids.'}),
  P(19,'Fresh Street Himalayan Pink Salt Onion 125g','Fresh Street','grocery',510,0,4.4,28,50,'1585428103455-9b8c6e0f1f8c',{featured:true,description:'Himalayan pink salt with onion flavor, 125g. Premium seasoning.'}),
  P(20,'Fresh Street Himalayan Pink Salt Jar 2.25KG','Fresh Street','grocery',750,0,4.5,22,30,'1585428103455-9b8c6e0f1f8c',{description:'Himalayan pink salt, 2.25KG jar. Bulk value pack.'}),
  P(21,'Aero Mint Assorted Candy Sugar Free 300g','Aero','grocery',925,0,4.2,12,40,'1585428103455-9b8c6e0f1f8c',{description:'Assorted mint candy, sugar free, 300g. Refreshing and guilt-free.'}),
  ...
  P(24,'Glam Gas Built In Hob Tempered Glass 3 Burner Digital','Glam Gas','appliances',25500,0,4.3,8,7,'1556909114-f6e7ad7d3136',{description:'Tempered glass auto ignition 3 heatrayz burner built-in hob, digital model.'}),
  ...
  P(27,'Glam Gas Multi Function Range Hood 90CM','Glam Gas','appliances',44400,0,4.3,10,6,'1556909114-f6e7ad7d3136',{description:'Multi function range hood with auto clean kitchen chimney, 90CM.'}),
  ...
  // ---- Phones & Computers ----
  P(33,'Redmi Buds 8 Lite Earbuds ANC White','Redmi','electronics',8500,0,4.5,85,20,'1518770660439-4636460b7eb1',{featured:true,bestSeller:true,trending:true,description:'Redmi Buds 8 Lite earbuds with ANC, 475mAh case battery, IP54 water resistant.'}),
  P(34,'Redmi Buds 8 Active Blue','Redmi','electronics',7600,0,4.4,62,25,'1518770660439-4636460b7eb1',{description:'Redmi Buds 8 Active, 475mAh case battery, IP54 water & dust resistant.'}),
  P(35,'Xiaomi MI Power Bank 22.5W 20000mAh Dark Gray','Xiaomi','electronics',7800,0,4.6,45,30,'1609591218476-74b761959e2c',{trending:true,description:'MI power bank with integrated cable, 22.5W, 20000mAh.'}),
  P(36,'Xiaomi MI 67W Power Bank 20000mAh Tan','Xiaomi','electronics',14500,0,4.5,28,12,'1609591218476-74b761959e2c',{description:'67W power bank with integrated cable, 20000mAh.'}),
  P(37,'Joyroom PD Fast Charger 30W With Cable','Joyroom','electronics',3325,3500,4.3,15,40,'1609591218476-74b761959e2c',{isNew:true,description:'PD fast charger 30W PD + QC 3.0 with 1-meter Type-C cable. 5% OFF!'}),
  P(38,'Samsung A37 Smartphone 8+256GB White','Samsung','electronics',149999,0,4.7,95,4,'1512991104335-231f067a4863',{featured:true,description:'6.7" Super AMOLED display, 8+256GB, 5000mAh battery, IP68.'}),
  P(39,'TP-LINK AX1800 Wi-Fi 6 PCIe Adapter','TP-LINK','electronics',9400,10000,4.4,12,15,'1609591218476-74b761959e2c',{description:'AX1800 dual band Wi-Fi 6 Bluetooth 5.2 PCI Express adapter. 6% OFF!'}),
  P(40,'TP-LINK 4G LTE Router 300Mbps','TP-LINK','electronics',15886,16900,4.3,8,10,'1609591218476-74b761959e2c',{description:'Wireless N 4G LTE router, 300Mbps, 2 antennas. 6% OFF!'}),
  P(41,'TP-LINK AX3000 Wi-Fi 6 Range Extender','TP-LINK','electronics',24346,25900,4.5,5,6,'1609591218476-74b761959e2c',{description:'AX3000 Wi-Fi 6 range extender, 2402 Mbps. 6% OFF!'}),
  P(42,'HOCO Sonar Sports Bluetooth Speaker','HOCO','electronics',4059,0,4.2,20,35,'1609591218476-74b761959e2c',{bestSeller:true,description:'Sonar sports Bluetooth speaker, 1200mAh battery, 3 hours playtime.'}),
  // ---- Men's Fashion ----
